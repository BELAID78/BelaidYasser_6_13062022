class PhotographerCard {
    ...
    createPhotographerCard(tab) {
        ...
        const photographerCard = `
                                    ...
                                    <a href="photographer.html?id=${this._photographer._id}" tabindex="${tab}"> <h2 title="${this._photographer._name}">${this._photographer._name}</h2></a>
